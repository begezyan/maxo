...
.. list-table::
   ...
   * - Моноширинный
     - ``<code>текст</code>``
     - `` `текст` ``
     - не задокументирован, работает; не отображается в web-версии
   * - Цитата
...
.. note::
   ...
   ``<code>`` и ``<blockquote>`` не упомянуты в официальной документации MAX, однако работают.
   ``<code>`` не отображается в web-версии клиента.
